...
<html lang="en">
                ...
                <div class="modal-content cursor-pointer" data-toggle="modal" data-target="#modal-1">
                    ...
                    <form id="frmGuardar" method="post">
                        <div class="modal-body">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Precio <span style="color: red;">*</span></label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Stock <span style="color: red;">*</span></label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="stock" name="stock" min="0">
                                </div>
                            </div>

                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Estado<span style="color: red;">*</span></label>
                                <div class="col-sm-9">
                    ...
                    <form id="frmEditar" method="post">
                        <div class="modal-body">
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Nombre <span style="color: red;">*</span></label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="nombreM" name="nombre" maxlength="60">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Precio <span style="color: red;">*</span></label>
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" id="precioM" name="precio" min="0">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Stock <span style="color: red;">*</span></label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="stockM" name="stock" min="0">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Estado<span style="color: red;">*</span></label>
                                <div class="col-sm-9">
                                    <select class="form-control" id="estadoM" name="estado">
                                        <option value="A">Activo</option>
                                        <option value="I">Inactivo</option>
                                    </select>
                                </div>
    ...
    <script type="text/javascript">
        ...
        function CargarDatos(id) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $("#stockM").val(data.stock);
                    $("#estadoM").val(data.estadoProducto);
        ...
        function Confirmar(id) {
            bootbox.confirm({
                message: "¿Está seguro que desea eliminar el producto con id " + id + "?",
                buttons: {
                    confirm: {
                        label: 'Eliminar',
